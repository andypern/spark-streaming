...
object m7import {
  def main(args: Array[String]) {
    ...
    //not sure what this is..doesn't compile though.
   ...
   // val lines = records.flatMap(_.split("\n"))
    ...
    //basically, foreach rdd inside the Dstream, perform a 'collect' on the RDD, and run a foreach on the elements
    //within the array that is generated by the collect.
    records.foreach(rdd => {
